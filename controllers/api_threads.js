...
module.exports.put = (req, res) => {
  ...
  Threads.findOneAndUpdate({ _id: req.body.thread_id }, { reported: true }, (err, data) => {
    if (err) {
      console.log(err);
    }
...
module.exports.delete = (req, res) => {
  ...
  Threads.deleteOne({ _id: req.body.thread_id, delete_password: req.body.delete_password }, (err, data) => {
    if (err) {
      console.log(err);
